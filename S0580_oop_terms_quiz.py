...
class Building:  # class definition
    def __init__(self, area, floors, value):  # constructor with parameters
        # attributes
        self.area = area
        self.floors = floors
        self._value = value
    ...
    def _adjust_value(self, percentage):  # encapsulation: protected method
...
skyscraper = Skyscraper(5000, 25, 10000000)  # Object definition
